      ...
      <HeaderWrapper>
        ...
        <div>
          <h1
            ...
            `}
          >
            Offrez un <BlueEm>calcul personnalisé</BlueEm> et à jour des aides à
            la <BlueEm>rénovation énergétique</BlueEm> à vos utilisateurs.
          </h1>
        </div>
      </HeaderWrapper>
      <Wrapper $noMargin={true}>
        <Content>
          <h2
            ...
            `}
          >
            Intégrez la solution <BlueEm>Mes Aides Réno</BlueEm>
            <br />
      ...
      <Wrapper $background="white" $noMargin={true}>
        <Content>
          <h2 css={'text-align: center; margin-bottom: 4rem;'}>
            ...
            de <BlueEm>Mes Aides Réno</BlueEm> pour votre activité
          </h2>
          <OrderedList>
            <li>
            ...
            <li>
              <Image src={iconCogs} alt="icone rouage" />
      ...
      <Wrapper $noMargin={true}>
        <Content>
          ...
          >
            ...
            <li>
              <Image src={checkIcon} width="30" alt="Icône case cochée" />
              des modules spécifiques pour les passoires thermiques, les pompes
              à chaleur, les copropriétés, les aides CEE…
            </li>
            <li>
              <Image src={checkIcon} width="30" alt="Icône case cochée" />
