  ...
  return !isInIframe && (
    <>
      <FooterWrapper className="fr-footer" role="contentinfo">
        <div css={`width: 800px;max-width: 90vw;margin: 0 auto;`}>
          ...
          <div className="fr-footer__bottom">
            ...
            <div className="fr-footer__bottom-copy">
              <p>
                ...
                <ExternalLink href="https://github.com/betagouv/reno/blob/master/LICENSE" target="_blank" title="licence MIT - nouvelle fenêtre" css={`text-decoration: underline`}>licence MIT</ExternalLink>
              </p>
            </div>
          </div>
        </div>
