...
export default function MaPrimeAdaptBailleur({
  engine,
  situation,
  setSearchParams,
  answeredQuestions,
  ...
  return (
    ...
    >
      ...
      {expanded && (
        <>
          <p>
            Il est obligatoire de signer une convention avec l'Agence nationale
            de l'habitat (Anah) pour bénéficier de l'aide.
          </p>
            ...
            <p>
              ...
              <label>
                <Input
                  ...
                  `}
                  autoFocus={false}
                  value={situation['mpa . montant travaux']}
                  min="1000"
                  onChange={(rawValue) => {
