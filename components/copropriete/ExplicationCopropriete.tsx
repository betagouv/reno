...
export default function ExplicationCopropriete() {
    ...
    return (
      <Section>
        ...
        { !isEligibile ? 
          <>
            <p>Votre copropriété <PrimeStyle $red={true}><strong>n'est pas éligible</strong></PrimeStyle> au dispositif <strong>MaPrimeRénov' Copropriété</strong></p>
            <div
              css={`
            ...
            >
              ...
              <p>Les copropriétaires sont <strong>peut-être éligibles individuellement</strong> à d'autres aides à la rénovation.<br />
                C'est pourquoi, nous vous invitons à refaire une simulation pour avoir un aperçu de l'ensemble de vos aides.
              </p>
            </div>
            <CTAWrapper $justify="center">
              <CTA $fontSize="normal">
                <Link href="/simulation">➞&nbsp;&nbsp;Simulez l'ensemble de vos aides</Link>
              </CTA>
            </CTAWrapper>
          </> :
          <>
