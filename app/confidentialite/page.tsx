      ...
      <Main>
        <Section>
          ...
          <p>
            ...
            saisissez par exemple votre catégorie de revenu, cette information
            est reçue par notre serveur (car les données sont stockées dans la
            barre d'adresse de votre navigateur).
          </p>
          <p>
            L'adresse est stockée dans notre outil de suivi d'audience, mais
            aucun compte utilisateur nominatif n'est créé et les données ne sont
            utilisées que pour améliorer les parcours sur le site et la
            fiabilité du modèle de calcul.
          </p>
          <p>
          ...
          <p>
            ...
            simulation sur d'autres sites Web, les données que vous saisissez
            dans notre simulateur peuvent être ensuite partagées au site tiers
          ...
          <p>
            Dans le cadre de l'intégration particulière de notre simulateur sur
            le site jagis.beta.gouv.fr, nous autorisons le partage des données
            de simulation au système d'information du service J'agis pour
          ...
          <p>
            Les membres habilités de l’équipe “J’agis” du Secrétariat général à
            la planification écologique (SGPE) et de la Direction
            interministérielle du numérique (DINUM) dans le cadre de
            l’intégration du simulateur d’aides via iFrame sont alors
            responsables du traitement des données partagées.
          </p>
          <h2>Serveur</h2>
          <p>
