    ...
    <>
      ...
      <PageBlock>
        ...
        >
          ...
          <p>
            Saviez-vous que la performance énergétique de votre logement influe
            fortement sur sa valeur immobilière ?
          </p>
          <p>
            Grâce à la calculette Ma plus-value Réno, estimez facilement
            l'impact de vos travaux de rénovation sur la valeur de votre bien.
          </p>
        </HeaderWrapper>
        <Suspense>
          <div
          ...
          >
            ...
            <p>
              L'équipe derrière la calculette, c'est l'équipe de Mes Aides Réno.
              Il s'agit d'un simulateur officiel des aides à la rénovation des
              logements, financé exclusivement sur fonds publics (Anah, DINUM,
              SGPE). Ce financement public permet de proposer des outils neutres
              et gratuits, au service des usagers et des professionnels.
            </p>
            <h2>
            ...
            <p>
              ...
              <a className="fr-link" href={`/module/plus-value/demonstration`}>
                intégrée
              </a>{' '}
