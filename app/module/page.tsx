          ...
          <Wrapper $background="white" $noMargin={true} $last={true}>
            <Content>
              ...
              <p>
                ...
                profiterez automatiquement des mises à jour qui ont lieu au
                cours de l'année et surtout aux importantes mises à jour
                annuelles.
              </p>
              <h2>Historique des versions</h2>
              <h3>v1 (été 2024)</h3>
              <p>
                La première version "preuve de concept" du module. Elle
                n'intègre que le dispositif principal MaPrimeRénov' parcours
                accompagné.{' '}
              </p>
              <h3>v2 (septembre 2024)</h3>
              <p>
                Le module est redesigné suite aux premiers retours du premier
                intégrateur. Les saisies utilisateur sont améliorées avec un
                choix simple dans un menu déroulant pour décrire la situation de
              ...
              <p>
                ...
                aussi les autres aides principales dont l'éco-PTZ, le prêt
                avance rénovation, le dispositif Denormandie, etc.
              </p>
              ...
              <p>
                ...
                <strong>
                  les 4 questions s'affichent désormais une par une
                </strong>
                , tout en gardant les 4 visibles dès le départ pour qu'il n'y
                ait aucune surprise.{' '}
              </p>
              <p>
                La saisie du revenu ne se fait plus à l'euro près de façon
                libre, mais via des <strong>seuils de revenu calculés</strong>{' '}
                en fonction des 3 réponses précédentes, pour éviter ainsi à
              ...
              <div>
                ...
                <ul>
                  <li>
                    les données injectées par l'annonce (m2, ville,
                    maison/appart) et le module (motif d'achat, revenu, etc.)
                    sont auto-remplies pour raccourcir la simulation et amener
                    l'utilisateur au plus vite vers la page de bilan des aides
                  </li>
                  <li>
                    un message l'avertit de ce procédé pour lui faire comprendre
                    que ces données sont bien prises en compte dans la
                    simulation
                  </li>
                </ul>
              </div>
              <p>
                <small>
                  ...
                  <a href="https://github.com/betagouv/reno/pull/281">
                    par ici
                  </a>{' '}
              ...
              <p>
                Au passage, fini le risque de mal informer l'utilisateur
                distrait, l'oeil attiré par les résultats verts en milliers d'€,
                avec des aides moyennes auxquelles il n'a pas accès donc avec un
                potentiel de déception important.
              </p>
              <p>
                Autre changement notable : nous ne posons plus la question du
                DPE cible. Nous prenons une hypothèse d'un saut de DPE suffisant
                pour obtenir MaPrimeRénov' et mentionnons cela tout en bas : la
              ...
              <p>
                ...
                champs de saisie différait des autres ; l'affichage des
                résultats était moins lisible sans organisation de type tableau
                à deux colonnes ; nous avons clarifié la question "Île de
                France" en évitant l'approche par la négative, même si cela
                occupe une nouvelle ligne verticale.
              </p>
            </Content>
          </Wrapper>
        </PageBlock>
