      ...
      <Main>
        <Section>
          ...
          <p>
            ...
            votre service. Si votre objectif est simplement de l'intégrer dans
            une page Web ou un article de blog, nous avons{' '}
        ...
        <Section>
          ...
          <p>
            ...
            d'intégrer le moteur de calcul publicodes chez vous. C'est ce qui
            rend la démonstration plus haut si fluide, les calculs sont faits{' '}
          ...
          <p>
            Ci-dessous, un exemple très basique d'intégration du modèle de
            calcul dans une maquette de projet NextJS.
          </p>
          <br />
          <NPMExampleProject />
        </Section>
