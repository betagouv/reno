    ...
    <Main>
      <Section>
        ...
        <p>
          ...
          sauts de DPE envisagés, mais aussi le projet d'isolation par geste.
        </p>
        <p>
        ...
        <p>
          ...
          questions auquel l'utilisateur doit encore répondre (c'est une API
        ...
        <p>
          ...
          <Link href="https://github.com/laem/mar/">Github</Link>. Les règles
          sont aussi accessibles en JSON{' '}
