...
export default function API() {
  return (
    <PageBlock>
      ...
      <p>
        L'API permet, à partir d'une situation d'entrée, d'évaluer l'éligibilité
        ainsi que le montant d'aides auxquels l'utilisateur peut prétendre.
      </p>
      <p>
      ...
      <p>
        ...
        qui recense l'entièreté des paramètres disponibles ainsi que davantage
        de documentation.
      </p>
      <ParametersList />
