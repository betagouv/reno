      ...
      <Main>
        <Section>
          ...
          <div className="fr-callout fr-icon-info-line">
            ...
            <p>
              Vous êtes éligible aux aides des fournisseurs d’énergie
              (certificats d’économies d’énergie – CEE) si :
            </p>
            <ul>
              <li>
              ...
              <li>
                le logement a été{' '}
                <strong>construit depuis plus de 2 ans.</strong>
              </li>
              <li>
                il s'agit de votre{' '}
            ...
            <p>
              ...
              , mais le montant des aides des fournisseurs d’énergie
              (certificats d’économies d’énergie – CEE) peut varier en fonction
              de vos revenus.
            </p>
          </div>
          <h2>
