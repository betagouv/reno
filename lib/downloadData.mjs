...
const sources = [
  {
    ...
    deactivatedBecauseOfDownloadBug:
      'https://www.data.gouv.fr/fr/datasets/liste-des-communes-couvertes-par-des-operations-de-revitalisation-de-territoire/#/discussions',
  },
  {
