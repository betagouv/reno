...
En termes de fiabilité du modèle, nous avons des tests sours forme de "personas" qui nous permettent de surveiller la non-régression notamment lors des mises à jour du modèle de calcul quand la loi ou les règlements changent. 

Nous n'avons pas encore de tests en réel (via un navigateur factice) des parcours utilisateur.  
